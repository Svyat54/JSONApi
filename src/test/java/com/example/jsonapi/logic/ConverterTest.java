...
class ConverterTest {
    ...
    void conv() {
        ...
        //Проверка пустоты
        assertEquals(converter.conv(new JSONMessage.InputMessage("2k16", null, null)).hexNumber, "is Empty");
        assertEquals(converter.conv(new JSONMessage.InputMessage("16k2", null, null)).toBinary, "is Empty");
        //Не совпадение
